...
return!0}}function f(a,b,c,f,d,e){var g=null,i=[];if(typeof a==="string"){g=f===!0?b.parentNode.getElementsByTagName(a):b.getElementsByTagName(a);for(h=0;h<g.length;h++)d===!0&&g[h]===(g[h].parentNode.firstElementChild||g[h].parentNode.firstChild)?c===!0&&g[h].parentNode===b?i.push(g[h]):f===!0&&(g[h]===b.nextElementSibling||g[h]===b.nextSibling)?i.push(g[h]):!c&&!f&&i.push(g[h]):d||(c===!0&&g[h].parentNode===b?i.push(g[h]):f===!0&&(g[h]===b.nextElementSibling||g[h]===b.nextSibling)?i.push(g[h]):
!c&&!f&&i.push(g[h]))}else if(a instanceof Array)for(k=0;k<a.length;k++){g=f===!0?b.parentNode.getElementsByTagName(a[k]):b.getElementsByTagName(a[k]);for(h=0;h<g.length;h++)c===!0&&g[h].parentNode===b?i.push(g[h]):f===!0&&(g[h]===b.nextElementSibling||g[h]===b.nextSibling)?i.push(g[h]):!c&&!f&&i.push(g[h])}else{g=f===!0?b.parentNode.getElementsByTagName("*"):b.getElementsByTagName("*");for(h=0;h<g.length;h++)c===!0&&g[h].parentNode===b?i.push(g[h]):f===!0&&(g[h]===b.nextElementSibling||g[h]===b.nextSibling)?
i.push(g[h]):!c&&!f&&i.push(g[h])}if(e){a=null;b=[];c=null;for(c=0;c<i.length;c++)for(a=i[c];a.parentNode;){if(a.getAttribute("lang")===e){b.push(i[c]);break}a=a.parentNode}e=b}else e=i;return e}var m=[],n=[],r=typeof b!=="undefined"?b:document,k=null,h=null,t=null;t=null;var o=this.clone();if(typeof a==="object")if(typeof a.nodeName==="string")return o[0]=a,o.elements=[a],o.length=1,o;else if(typeof a.target==="object")return o[0]=a.target,o.elements=[a.target],o.length=1,o;if(this.elements instanceof
...
Spark.extend("data",function(a,b){var c=null,d=null,e=null;if(this.elements instanceof Array&&this.length!==0){d=this.elements[0];e=-1;if(typeof this.dataMeta.keys.indexOf!=="undefined")e=this.dataMeta.keys.indexOf(d);else for(c=0;c<this.dataMeta.keys.length;c++)this.dataMeta.keys[c]===d&&(e=c);if(typeof b!=="undefined"){if(e===-1)e=this.dataMeta.keys.length,this.dataMeta.keys.push(d),this.dataMeta.data.push({});this.dataMeta.data[e][a]=b;return this}else{if(e===-1)return!1;return typeof this.dataMeta.data[e][a]!==
"undefined"?this.dataMeta.data[e][a]:!1}}return!1});Spark.extend("attribute",function(a,b){var c=this;if(typeof a==="string")if(typeof b==="string")this.each(function(c){c.setAttribute(a,b)});else return this.length!==0?this[0].getAttribute(a):!1;else typeof a==="object"&&this.each(function(a,b){c.each(function(c){c.setAttribute(b,a)})},a);return this});
Spark.extend("style",function(a,b){function c(a){if(a.indexOf("-")!==-1)return a.replace(/-([a-z])/gi,function(a,b){return b.toUpperCase()});return a}function d(a){return a.replace(/([A-Z])/g,function(a){return"-"+a.toLowerCase()})}function e(a,b,f){var d=null;b=c(b);typeof f==="number"&&!RegExp("(^|\\s)"+b+"($|\\s)","i").test("zIndex fontWeight opacity zoom lineHeight scrollTop scrollLeft")?f+="px":typeof f==="number"&&(f=f.toString());b==="scrollTop"||b==="scrollLeft"?a[b]=f:a.style[b]=f;if(b===
"opacity")a.style.zoom="1",a.style.filter="alpha(opacity="+parseFloat(f)*100+")",a.style.MozOpacity=f,a.style.KhtmlOpacity=f}function f(a,b){var c=null;if(b==="scrollTop"||b==="scrollLeft")return a[b];(c=typeof getComputedStyle!=="undefined"?document.defaultView.getComputedStyle(a,null).getPropertyValue(d(b)):a.currentStyle[b])||(c=a.style[b]);!c&&c!==0&&(c=b==="opacity"?"1":"0");b.toLowerCase().indexOf("color")!==-1&&(c=r.color.toRgb(c));return c}var m=null,n=null,r=this,k=null;if(typeof a==="string")if(typeof b===
"string"||typeof b==="number")for(m=0;m<this.length;m++)e(this[m],a,b);else if(this.length!==0)if(a==="padding"||a==="margin"){k=[f(this[0],c(a+"Top")),f(this[0],c(a+"Bottom")),f(this[0],c(a+"Left"))];for(m=1;m<2;m++)if(k[0]!==k[m])return"";return k[0]}else return f(this[0],c(a));else return!1;else if(typeof a==="object")for(n in a)if(a.hasOwnProperty(n))for(m=0;m<this.length;m++)e(this[m],n,a[n]);return this});
...
f.slice(0,f.length-1)+"]")}else if(typeof a==="object"){for(e in a)a.hasOwnProperty(e)&&(f+=this.stringify(a[e],e)+",");return c("{"+f.slice(0,f.length-1)+"}")}else return typeof a==="string"?c(d(a)):c(a.toString())}});
Spark.extend("hasClass",function(a){var b=null,c=!0,d=null,e=null;if(this.length!==0)b=this[0],d=this.find(b);else return!1;e=d.attribute("class")?"class":"className";return a instanceof Array?(this.each(function(a){RegExp("(^|\\s)"+a+"($|\\s)").test(d.attribute(e))||(c=!1)},a),c):RegExp("(^|\\s)"+a+"($|\\s)").test(d.attribute(e))});
...
Spark.extend("html",function(a,b){if(typeof a==="undefined")return this.length!==0?this[0].innerHTML:!1;this.each(function(c){b?c.innerHTML+=a:c.innerHTML=a});return this});Spark.extend("text",function(a,b){var c=document.body.innerText?"innerText":"textContent";if(typeof a==="undefined")return this.length!==0?this[0][c]:!1;this.each(function(d){b?d[c]+=a:d[c]=a});return this});
...
Spark.extend("property",function(a,b){var c=this;if(typeof a==="string")if(typeof b==="string")this.each(function(c){c[a]=b});else return this.length!==0?this[0][a]:!1;else typeof a==="object"&&this.each(function(a,b){c.each(function(c){c[b]=a})},a);return this});
